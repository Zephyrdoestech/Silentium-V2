...
public class CombatScreen extends BaseScreen {
    ...
    // We will use the textures from game.assets, and keep track of them in an array for easy iteration.
    ...
    public void show() {
        ...
        // Initialize pause buttons array
    ...
    private void renderPauseScreen(float delta) {
        ...
        float pulse = (com.badlogic.gdx.math.MathUtils.sin(animTimer * 6f) + 1f) / 2f;
